...
const ProjectPreview = () => {
  ...
  useGSAP(() => {
    // Only create animation for screens larger than 1024px (laptop)
  ...
  return (
    <div className='h-fit lg:h-[100vh] overflow-hidden'>
      <div className="w-screen relative overflow-hidden py-16 bg-black" ref={containerRef}>
        <div className='content w-full overflow-hidden lg:translate-y-[100%]' >
        ...
        <div className=' absolute bottom-10   md:scale-[0.60] md:-bottom-20 lg:-bottom-32 lg:right-24 lg:-translate-y-[162%]' ref={mobileRef}>
