...
const Navigation = () => {
  ...
  return (
    <div className="w-screen absolute h-screen flex text-white  overflow-hidden z-[500]">
<div
  ref={container1Ref}
  className="container-1 overflow-hidden bg-[#2722df] h-full  hidden lg:flex lg:w-[25%] flex-col justify-between"
>
      ...
      <div  ref={container2Ref} className="container-2 bg-[#4541f1] h-full   w-full lg:w-[75%] p-8 px-4 absolute right-0    bottom-0  ">
